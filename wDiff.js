...
if (typeof(wDiffStyleDelete) == 'undefined') { wDiffStyleDelete = 'font-weight: normal; text-decoration: none; color:' + REC.file1TextColour + 'background-color:' +  REC.file1Background;}
if (typeof(wDiffStyleInsert) == 'undefined') { wDiffStyleInsert = 'font-weight: normal; text-decoration: none; color:' + REC.file2TextColour + 'background-color:' + REC.file2Background;}
...
if (typeof(wDiffHtmlDeleteEnd)   == 'undefined') { wDiffHtmlDeleteEnd   = '</span>'; }
 
if (typeof(wDiffHtmlInsertStart) == 'undefined') { wDiffHtmlInsertStart = '<span class="wDiffHtmlInsert" style="' + wDiffStyleInsert + '">'; }
if (typeof(wDiffHtmlInsertEnd)   == 'undefined') { wDiffHtmlInsertEnd   = '</span>'; }
...
if (typeof(wDiffWordDiff) == 'undefined') { wDiffWordDiff = false; }
...
//  console.log(text.newWords)
//   console.log(text.oldWords)
    return;
};
